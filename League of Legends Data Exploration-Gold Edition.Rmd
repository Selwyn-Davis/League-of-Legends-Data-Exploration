...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="TSM")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "TSM")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="TL ")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "TL ")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="C9 ")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "C9 ")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="FOX")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "FOX")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="CLG")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "CLG")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="DIG")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "DIG")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="NV ")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "NV ")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="P1 ")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "P1 ")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="IMT")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "IMT")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
...
GpM<- as.numeric(unlist(subset(team_role_avgs_Spring17, teamId=="FLY")["Player_mean_goldEarnedpMin"]))
pct <- round(GpM/sum(GpM)*100, digits = 3)
lbls<- unlist(subset(team_role_avgs_Spring17, teamId== "FLY")["role"])
lbls <- paste(lbls, pct)  
lbls <- paste(lbls,"%",sep="")
